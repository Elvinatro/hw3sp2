...
export const pureAddUser = (
    name: string,
    setError: (value: string | null) => void, setName: (name: string) => void,
...
export const pureOnBlur = (name: string, setError: (value: string | null) => void) => { // если имя пустое - показать ошибку
    if (name.trim() === "") {
        setError("Ошибка! Введите имя!")
    }
}
